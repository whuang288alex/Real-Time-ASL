...
class ASLDetector():
    def __init__(self, predictor, margin=20, font_size=1, font_thickness=3, text_color=(76, 175, 80)):
        # define constants
        self.MARGIN = margin
    ...
    def draw_landmarks_on_image(self, rgb_image, detection_result):
        ...
        if hand_landmarks_list:
            ...
            for idx in range(len(hand_landmarks_list)):
                ...
                annotated_image = cv2.rectangle(annotated_image, (min_x, min_y), (max_x, max_y), self.TEXT_COLOR, 3)
